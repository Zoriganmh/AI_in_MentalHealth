...
def load_model_and_tokenizer():
    ...
    # Cấu hình dropout 0.3 cho BERT theo bài báo
...
def get_training_args(prefix, batch_size):
    ...
    return TrainingArguments(
        ...
        num_train_epochs=10,        # 10 epochs theo bài báo
        learning_rate=1e-5,         # LR 1e-5 theo bài báo
        weight_decay=0.01,
...
def main():
    ...
    # Cấu hình: (tên_tiền_tố, batch_size tương ứng)
    configs = [
        ("both", 16),
        ("posts", 16),
        ("titles", 32)
    ...
    for prefix, batch_size in configs:
        ...
        print(f"Training complete for BERT - {prefix}. Model saved.\n")
